...
const updatePatientProfile = async (req, res, next) => {
    try {
        const {
            ...
            lifestyle,
            emergencyContact,
            vitals // 🔥 NEW: req.body se vitals ko extract kiya
        } = req.body;
        ...
        if (profile) {
            ...
            // 🔥 NEW: Agar frontend se vitals aaye hain, toh unhe update karo
            if (vitals) {
            ...
            profile = await PatientProfile.create({
                ...
                lifestyle,
                emergencyContact,
                vitals // 🔥 NEW: Naye profile create karte waqt bhi vitals save karo
            });
